...
export const SubscriptionCardWrapper = styled('div', ({ $theme }) => ({
  height: '100%',
  width: '100%',
...
export const SubscriptionImageWrapper = styled('div', ({ $theme }) => ({
  height: '240px',
  padding: '5px',
  position: 'relative',
...
export const SubscriptionInfo = styled('div', ({ $theme }) => ({
...
export const SubscriptionTitle = styled('h3', ({ $theme }) => ({
...
export const SubscriptionWeight = styled('span', ({ $theme }) => ({
...
export const SubscriptionMeta = styled('div', ({ $theme }) => ({
  marginTop: '15px',
  display: 'flex',
  alignItems: 'center',
...
export const SubscriptionPriceWrapper = styled('div', ({ $theme }) => ({
  display: 'flex',
  alignItems: 'center',
  position: 'relative',
}));

export const SubscriptionPrice = styled('span', ({ $theme }) => ({
  ...$theme.typography.fontBold14,
